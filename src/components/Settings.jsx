    ...
    return (
        <section className="quiz-settings">
            <div className="settings-title">
                <div className="settings-icon-p">
                    {settingsIcon}
                    <p className="settings-p">Quiz settings</p>
                </div>
            </div>
            <div className="settings-row">
                <label className="settings-label" htmlFor="amount">Questions:</label>
                <input onChange={saveSettings} className="settings-number-input" name="amount" id="amount" type="number" defaultValue={gameSettings.amount} min="1" max="50"></input>
            </div>
            <div className="settings-row">
                <label className="settings-label" htmlFor="category">Category:</label>
                <select onChange={saveSettings} className="settings-select" name="category" id="category" defaultValue={gameSettings.category}>
            ...
            <div className="settings-row">
                ...
                <select onChange={saveSettings} className="settings-select" name="difficulty" id="difficulty" defaultValue={gameSettings.difficulty}>
                    <option value="">Any</option>
            ...
            <div className="settings-row">
                ...
                <select onChange={saveSettings} className="settings-select" name="type" id="type" defaultValue={gameSettings.type}>
                    <option value="">Any</option>
                    {gameTypesToRender}
                </select>
            </div>
